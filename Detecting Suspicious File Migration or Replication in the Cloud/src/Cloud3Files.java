...
public class Cloud3Files extends JFrame implements ActionListener
{
...
setTitle("CS3->View Files::Detecting Suspicious File Migration or Replication in the Cloud");
c= getContentPane();
	 ...
	 heading.addElement("Cloud Server");
			  ...
			  DBCon db = new DBCon();
				Connection con = db.getConnection();
	             ...
	             String query = "SELECT * From  cloudfiles where cloudname='CS3'";
