...
public class CS2ViewUsersMemory extends JFrame implements ActionListener
{
...
setTitle("CS2->View Users VM::Detecting Suspicious File Migration or Replication in the Cloud");
c= getContentPane();
c.setLayout (null);
	 ...
	 heading.addElement("Cloud");
			  ...
			  DBCon db = new DBCon();
				Connection con = db.getConnection();
	             ...
	             String query = "SELECT * From  owner where cloudname='CS2'";
