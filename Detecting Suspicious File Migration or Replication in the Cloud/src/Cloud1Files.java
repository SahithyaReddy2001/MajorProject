...
public class Cloud1Files extends JFrame implements ActionListener
{
...
setTitle("CS1->View Files::Detecting Suspicious File Migration or Replication in the Cloud");
c= getContentPane();
...
try {
	 ...
	 heading.addElement("Soft MAC Key");
	 heading.addElement("Cloud Server");
			  ...
			  DBCon db = new DBCon();
				Connection con = db.getConnection();
	             ...
	             String query = "SELECT * From  cloudfiles where cloudname='CS1'";
